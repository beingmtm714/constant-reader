...
import { EMPTY, bandKey } from './overrides.mjs?v=a8985e3957';
...
//
// An untagged chip shows to everyone, and for a long time thirty-seven of them
// were untagged — so a reader who said "fiction" was still offered biography,
// climate and university-press subjects. The gate is now decided by the corpus
// rather than by how a label reads: a chip is tied to one side only when the
// other side cannot be served. Measured over 193 scored fiction books and 486
// nonfiction, the seven that moved carry no fiction to offer — Institutions
// 1/38, Art and music 1/30, A life told 1/18, Work and the economy 1/15,
// Ecology 0/10, Illness and care 0/7, and A late reveal the other way at 3/0.
// Everything else fires on both and stays untagged: tone in full, structure,
// Poetry at 8 fiction to 9 nonfiction, and subjects like Crime, Migration and
// Science that novels and histories both take up. Re-measure before adding a
// tag here; the labels mislead and the counts do not.
...
export const CHIPS = [
  ...
  { dim: 'D1', band: 'device_twist', label: 'A late reveal', reads: 'fiction' },
  ...
  { dim: 'D2', band: 'institution', label: 'Institutions and how they form', reads: 'nonfiction' },
