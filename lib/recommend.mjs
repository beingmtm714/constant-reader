...
export function isRecommended({ scored, identity, fiction, inWindow, hasBook }) {
  ...
  if (outOfTen(scored.total) < RECOMMEND_AT) return { ok: false, because: `scores ${outOfTen(scored.total)}, below ${RECOMMEND_AT}` };
