...
import { DIMS, distance, vectorOf, weightsFrom } from './vector.mjs';
...
function reason({ matchedTags, hits, typed, echo, missing, reference, near }) {
  ...
  if (matchedTags.length) parts.push(matchedTags.slice(0, 4).join(', '));
  ...
  return parts.length ? parts.join(' · ') : 'Matched on the review text';
}
