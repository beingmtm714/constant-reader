...
import { DIMS, vectorOf, firedMask, weightsFrom, nearestOf, meanVector } from './vector.mjs?v=7724e033d2';
import { SAVED, PASSED, verdictOf } from './saved-books.mjs?v=7724e033d2';
