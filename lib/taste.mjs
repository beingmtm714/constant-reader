...
import { DIMS, vectorOf, firedMask, weightsFrom, nearestOf, meanVector } from './vector.mjs?v=a1e20bbf7e';
import { SAVED, PASSED, verdictOf } from './saved-books.mjs?v=a1e20bbf7e';
