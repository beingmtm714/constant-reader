...
import { DIMS, vectorOf, firedMask, weightsFrom, nearestOf, meanVector } from './vector.mjs?v=78f5eeab0f';
import { SAVED, PASSED, verdictOf } from './saved-books.mjs?v=78f5eeab0f';
