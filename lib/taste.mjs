...
import { DIMS, vectorOf, firedMask, weightsFrom, nearestOf, meanVector } from './vector.mjs?v=08e456a903';
import { SAVED, PASSED, verdictOf } from './saved-books.mjs?v=08e456a903';
