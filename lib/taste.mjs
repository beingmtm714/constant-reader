...
import { DIMS, vectorOf, firedMask, weightsFrom, nearestOf, meanVector } from './vector.mjs?v=5a97887a83';
import { SAVED, PASSED, verdictOf } from './saved-books.mjs?v=5a97887a83';
