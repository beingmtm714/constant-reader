...
import { DIMS, vectorOf, firedMask, weightsFrom, nearestOf, meanVector } from './vector.mjs?v=f3c1dd5be0';
import { SAVED, PASSED, verdictOf } from './saved-books.mjs?v=f3c1dd5be0';
