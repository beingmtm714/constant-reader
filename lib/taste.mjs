...
import { DIMS, vectorOf, firedMask, weightsFrom, nearestOf, meanVector } from './vector.mjs?v=2dff524985';
import { SAVED, PASSED, verdictOf } from './saved-books.mjs?v=2dff524985';
