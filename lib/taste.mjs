...
import { DIMS, vectorOf, firedMask, weightsFrom, nearestOf, meanVector } from './vector.mjs?v=ce26cab02f';
import { SAVED, PASSED, verdictOf } from './saved-books.mjs?v=ce26cab02f';
