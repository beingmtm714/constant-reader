...
import { DIMS, vectorOf, firedMask, weightsFrom, nearestOf, meanVector } from './vector.mjs?v=47f9c4b88f';
import { SAVED, PASSED, verdictOf } from './saved-books.mjs?v=47f9c4b88f';
