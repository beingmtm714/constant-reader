...
import { DIMS, vectorOf, firedMask, weightsFrom, nearestOf, meanVector } from './vector.mjs?v=ac537f3435';
import { SAVED, PASSED, verdictOf } from './saved-books.mjs?v=ac537f3435';
