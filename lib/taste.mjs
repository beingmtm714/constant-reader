...
import { DIMS, vectorOf, firedMask, weightsFrom, nearestOf, meanVector } from './vector.mjs?v=bb5f9182b2';
import { SAVED, PASSED, verdictOf } from './saved-books.mjs?v=bb5f9182b2';
