...
import { DIMS, vectorOf, firedMask, weightsFrom, nearestOf, meanVector } from './vector.mjs?v=7324d439e1';
import { SAVED, PASSED, verdictOf } from './saved-books.mjs?v=7324d439e1';
