...
import { DIMS, vectorOf, firedMask, weightsFrom, nearestOf, meanVector } from './vector.mjs?v=924c1867d0';
import { SAVED, PASSED, verdictOf } from './saved-books.mjs?v=924c1867d0';
